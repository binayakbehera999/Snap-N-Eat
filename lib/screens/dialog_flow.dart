...
import 'package:snap_n_eat/utils/facts_message.dart';
...
class _FlutterFactsChatBotState extends State<FlutterFactsChatBot> {
  ...
  void agentResponse(query) async {
    ...
    await AuthGoogle(fileJson: "assets/chatbot/cred.json").build();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Virtual Agent", style: TextStyle(color: Colors.green[400]),),
