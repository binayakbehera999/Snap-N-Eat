  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: FluidNavBar( 
        icons: [
            FluidNavBarIcon(iconPath: "assets/icons/dashboard.svg",extras: {"label":""}),
            FluidNavBarIcon(iconPath: "assets/icons/account_circle.svg" ,extras: {"label":"Dashboard"}),
            FluidNavBarIcon(iconPath: "assets/icons/leaderboard.svg",extras: {"label":"partner"}),
          ],
