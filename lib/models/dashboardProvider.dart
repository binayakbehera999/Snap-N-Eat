...
class DashBoardProvider with ChangeNotifier {
  ...
  Map<String, dynamic> description = {
    'Individual Insurance': {
      'description':
          'Each individual is different and so are their medical needs. Consider taking an individual health insurance for yourself and each member of your family. With Bajaj Finserv’s Individual Health Insurance plan offerings, get coverage for expenses incurred due to hospitalization, doctor’s consultation, ambulance services, treatment charges or pre- and post-hospitalization.',
      'benefits': [
        'Sum insured up to Rs.50 lakh',
        'Medical tests exemption',
        'Comprehensive coverage',
        'Enjoy various discounts'
      ],
      'eligibility':
          'The following Bajaj Finserv loan customers can be covered under Bajaj Finserv’s Individual Health Insurance Plan offerings: \nYou should be between 18 years to 65 years of age. \nThe policy can be renewed for a lifetime.The entry age for a child is 3 months and goes up to 30 years.'
    },
    'Family Floater Insurance': {
      'description':
          'Cover your loved ones against any kind of illness or accident with a Family Health Insurance plan. Pay one single premium and provide a health insurance for yourself, your spouse and your kids. Pay for the hospitalization charges, consultation fees, and even medicines with a comprehensive cover from Bajaj Finserv’s Family Health Insurance plan offerings. Save time and money with a hassle-free medical coverage for your entire family.',
      'benefits': [
        'Coverage up to Rs.50 lakh',
        'Hassle-free',
        'Save tax',
        'Add a member easily'
      ],
      'eligibility':
          'A Bajaj Finserv loan customer is eligible for a family health insurance plan if the family members are between the age of 18 to 65 years and the age of dependent children should be between 3 months to 30 years.'
    },
    'Top-up Insurance': {
      'description':
    ...
    'Critical Illness Insurance': {
      ...
      'benefits': [
        'Cover up to Rs.50 lakh',
        'Lump Sum Payment',
        'Comprehensive usage',
        'Covers major illnesses'
      ],
      'eligibility':
          'If you are a Bajaj Finserv’s loan customer and looking for a critical illness health insurance, you are at the right place. To avail this policy, you should be Between the age of 18 to 65 years.'
    },
    'Employee Insurance': {
      'description':
          'Get a healthier workforce by taking a health cover for a group of people or your employees. Simply pay a single premium amount and secure your employees against medical emergencies. Enjoy higher discounts and more benefits with Group Health Insurance plans on our website. Cover the medical expenses of your group members as well as their dependents. Enjoy the hassle-free claims for medical expenses with cashless facility and easy reimbursement for hospitalization expenses.',
      'benefits': [
        'Medical benefits',
        'Cover dependents',
        'Save time and money',
      ...
      'eligibility':
          'If you are a Bajaj Finserv’s loan customer, you can get a group health insurance in a jiffy. You should be an employer or an employee group to take a group health insurance policy.'
    },
    'Personal Accident Covers': {
      'description':
      ...
      'eligibility':
          'If you are Bajaj Finserv’s loan customer you can easily get a Personal Accident Insurance. To apply for this plan, you need to be between the age of 18 to 65 years and dependents must be between the age of 5 to 21 years.'
    },
    'Maternity Insurance': {
      'description':
